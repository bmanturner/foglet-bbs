...
```
Task(
  prompt="Read /Users/brendan.turner/Dev/personal/foglet_bbs/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/brendan.turner/Dev/personal/foglet_bbs/.codex/get-shit-done/templates/SECURITY.md`
