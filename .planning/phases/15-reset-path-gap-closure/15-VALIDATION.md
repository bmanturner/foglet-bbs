...
| 15-02-02 | 02 | 1 | HYGN-03 | T-15-04 | README and Phase 14 blocker records agree about supported reset behavior | manual docs review | Manual review only; do not add README ExUnit tests or automated README test gates. | yes | pending |
...
- [ ] Documentation verification checks `README.md` and `.planning/phases/14-launch-hygiene-and-operator-notes/14-BLOCKERS.md` by manual review only, without README-specific ExUnit tests or automated README test gates.
...
- [x] All code-changing tasks have `<automated>` verify; README documentation checks are manual-only by user direction.
