# Requirements Archive: v2.0 TUI Runtime Shell & Screen Update Loops

**Archived:** 2026-04-29
**Status:** SHIPPED

The live `.planning/REQUIREMENTS.md` file is intentionally removed after milestone close. The next milestone will create fresh requirements with `$gsd-new-milestone`.
...
- [x] **SCREEN-05**: Account owns profile, preferences, SSH keys, invite tab state, save results, local theme preview, and form errors through the new update loop.
- [x] **SCREEN-06**: Moderation and Sysop own tab lifecycle loading, retry behavior, nested form/subview state, invites behavior, and loaded/error results through the new update loop.
...
- [x] **APP-04**: Modal handling remains App-level for overlay precedence, while screen-owned modal requests flow through generic modal effects.
...
| SCREEN-05 | Phase 38 | Complete |
| SCREEN-06 | Phase 38 | Complete |
| APP-01 | Phase 39 | Complete |
| APP-02 | Phase 39 | Complete |
| APP-03 | Phase 39 | Complete |
| APP-04 | Phase 39 | Complete |
...
*Last updated: 2026-04-29 after v2.0 audit repair*
