...
- [ ] **SCREEN-04**: PostReader, PostComposer, and NewThread own post loading, read-pointer flush requests, composer drafts, board picker state, reply/new-thread submission results, and navigation through the new update loop. (In progress: PostReader complete in Phase 37 Plan 01.)
