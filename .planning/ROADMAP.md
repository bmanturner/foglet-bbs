...
| `Foglet.Posts.list_posts/1` unbounded query (Phase 44 residual) | Phase 47 |
| `Foglet.Threads.list_threads/2` unbounded query | Phase 47 |
| Chrome V1 compatibility shims (KeyBar, ScreenFrame, StatusBar, Normalizer) | Phase 47 |
| `Foglet.TUI.App` residual size + screen_state plumbing + session aliasing | Phase 47 |
| `Foglet.TUI.Screens.Login` mixed-mode reducer (TUI-05 residual) | Phase 47 |
...
| 47. Bound unbounded list queries, drop Chrome V1 shims, and reduce App + large screen modules | 5/5 | Complete   | 2026-04-30 |
...
- [x] 47-03-PLAN.md — R5: Drop Chrome V1 shims (5 screen call sites + KeyBar/Normalizer deletion + V1 branch removal)
- [x] 47-04-PLAN.md — R6: Extract App.ScreenStates and App.SessionAlias; drop app.ex below 400 lines
- [x] 47-05-PLAN.md — R7: Decompose Login into per-mode reducer modules; drop login.ex below 300 lines
