...
**Plans**: 6 plans
  - [x] 02-01-PLAN.md — Wave 1: Config schema key `invite_generation_per_user_limit` + accessor + seed + test [INVT-06, INVT-07, SYSO-02]
  - [x] 02-02-PLAN.md — Wave 1: Actor-first category CRUD in `Foglet.Boards` + `archive_changeset/1` + test [SYSO-03]
  - [x] 02-03-PLAN.md — Wave 2: Sysop.State expansion + SITE/LIMITS inline-form submodules + partition test [INVT-06, INVT-07, SYSO-02]
  - [x] 02-04-PLAN.md — Wave 3: BOARDS tab submodule (Modal.Form create/edit + confirm archive) [SYSO-03]
  - [x] 02-05-PLAN.md — Wave 4: SYSTEM snapshot tab + final Sysop delegation + `mix precommit` gate [SYSO-04]
  - [x] 02-06-PLAN.md — Wave 5: Gap closure for BOARDS atom-error routing and LIMITS plain-char safety [SYSO-02, SYSO-03]
**UI hint**: yes
...
**Plans**: 3 plans
  - [x] 03-01-PLAN.md — Wave 1: Invite persistence foundation, Phase 2 dependency verification, and RED lifecycle/registration tests [INVT-02, INVT-03, INVT-04, INVT-05]
  - [x] 03-02-PLAN.md — Wave 2: Accounts-domain invite generation, status review, secure codes, policy/cap enforcement, and revocation [INVT-02, INVT-03, INVT-04]
  - [x] 03-03-PLAN.md — Wave 3: Invite-only registration transaction, single-use redemption, generic invite_code errors, and register preflight cleanup [INVT-05]
**UI hint**: no
...
**Plans**: 3 plans
  ...
  - [x] 07-03-PLAN.md — Wave 3: App-owned composer, load/refresh flow, validation errors, and `mix precommit` gate [ONEL-01, ONEL-02, ONEL-03]
**UI hint**: yes
