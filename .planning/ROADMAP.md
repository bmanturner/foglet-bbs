...
- [x] 39-07-PLAN.md — Wave 3: delete the seven legacy fields from %Foglet.TUI.App{}; clean render_fixtures.ex base_state/2; migrate or delete the ~25 legacy-construction sites in app_test.exs and post_reader_test.exs; remove all @tag :phase39_target annotations and the :phase39_target exclusion in test_helper.exs.
