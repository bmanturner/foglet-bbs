...
<reference>
@/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/references/user-profiling.md` to load:
