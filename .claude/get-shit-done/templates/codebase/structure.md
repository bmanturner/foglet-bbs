...
- Usage: Reference from command with `@/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/bfturner/Dev/local/foglet-bbs/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/bfturner/Dev/local/foglet-bbs/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
