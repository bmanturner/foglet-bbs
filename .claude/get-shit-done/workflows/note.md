...
- **Global scope**: `/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/notes/`)
...
2. Glob `/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/notes/` — works in any directory
