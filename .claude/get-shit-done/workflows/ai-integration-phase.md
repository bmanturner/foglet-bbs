...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-eval-planner.md for instructions.
