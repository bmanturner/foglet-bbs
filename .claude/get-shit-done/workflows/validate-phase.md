...
```
Task(
  prompt="Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/templates/VALIDATION.md`
