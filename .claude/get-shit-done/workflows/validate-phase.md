...
```
Task(
  prompt="Read /Users/brendan.turner/Dev/personal/foglet_bbs/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/get-shit-done/templates/VALIDATION.md`
