...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/bfturner/Dev/local/foglet-bbs/.claude/agents/gsd-ui-checker.md for instructions.
