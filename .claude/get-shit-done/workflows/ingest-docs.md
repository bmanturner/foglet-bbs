...
```bash
INIT=$(node "/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/brendan.turner/Dev/personal/foglet_bbs/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
