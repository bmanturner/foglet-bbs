...
```bash
node "/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/bfturner/Dev/local/foglet-bbs/.claude/get-shit-done/templates/retrospective.md`.
