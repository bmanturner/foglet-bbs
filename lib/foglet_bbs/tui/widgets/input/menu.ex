  ...
  **Pitfall 7 (RESEARCH.md):** The Raxol menu component requires
  ...
  defp render_item(item, depth, cursor, theme) do
    ...
    cond do
      disabled? ->
        row style: %{gap: 0} do
          row_runs(indent, glyph, label_cell, meta, shortcut, %{
            glyph_slot: theme.dim,
            label_slot: theme.dim,
            meta_slot: theme.dim,
            label_style: [:dim]
          })
        end
      ...
      selected? ->
        row style: %{gap: 0} do
          row_runs(indent, glyph, label_cell, meta, shortcut, %{
            glyph_slot: theme.accent,
            label_slot: theme.selected,
            meta_slot: theme.dim,
            label_style: [:bold]
          })
        end
  ...
  defp row_runs(indent, glyph, label_cell, meta, shortcut, slots) do
    %{
