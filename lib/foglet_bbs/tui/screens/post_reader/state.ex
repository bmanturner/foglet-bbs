defmodule Foglet.TUI.Screens.PostReader.State do
  ...
  @type t :: %__MODULE__{
          ...
          selected_action_post_index: non_neg_integer(),
          ...
          reply_context: Foglet.TUI.Widgets.Post.ReplyContext.t() | nil,
          last_op: atom() | nil,
          last_error: term() | nil,
          load_intent: term()
        }
  ...
  def new(opts \\ []) do
    %__MODULE__{
      ...
      selected_action_post_index:
        Keyword.get(opts, :selected_action_post_index, Keyword.get(opts, :selected_post_index, 0)),
      ...
      reply_context: Keyword.get(opts, :reply_context),
